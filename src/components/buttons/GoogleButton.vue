...
const loginWithGoogle = async (): Promise<void> => {
  if (authStore.player) {
    ...
    // } catch (error) {
    //   console.error('Erreur lors de la requête pour stocker le playerId:', error);
    // }
    window.location.href = `${apiUrl}/auth/google`;
  } else {
    window.location.href = `${apiUrl}/auth/google`;
